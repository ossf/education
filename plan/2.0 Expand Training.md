...
### Explanation: The primary objective of the Security Knowledge Framework (SKF) Operations Team is to ensure that SKF survives the test of time and is freely available for generations of Security learning
...
### Explanation:  Hire 2 Partnerships Office staff (one for historically underserved commnunities, one for traditional academia) for outrach and creating meaningfull relationships.
